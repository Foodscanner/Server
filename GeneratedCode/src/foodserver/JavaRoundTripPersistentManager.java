...
public class JavaRoundTripPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "JavaRoundTrip";
	...
	private JavaRoundTripPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new JavaRoundTripPersistentManager();
		}
